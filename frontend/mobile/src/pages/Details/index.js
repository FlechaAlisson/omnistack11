...
export default function Details(){
    ...
    const message = `Olá ${incident.nome}, estou entrando em contato pois gostaria de ajudar o caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR',{style: 'currency',currency: 'BRL'}).format(incident.value)}`
        ...
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                <Text style={[styles.incidentsProperty, {marginTop: 0}]}>ONG:</Text>
                 <Text style={styles.incidentsValue}>{incident.nome} de {incident.cidade}/{incident.uf}</Text>
